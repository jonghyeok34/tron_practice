...
const {
  ...
  buildTransferHexStr, buildTriggerSmartContract,getTriggerSmartContractParameterValue,
...
class ApiClient {
  ...
  async getTagNameList() {
    ...
    getParameterValue (hexStr){
        let hexStrBytes = hexStr2byteArray(hexStr);
        let parameterValue = getTriggerSmartContractParameterValue(hexStrBytes)
